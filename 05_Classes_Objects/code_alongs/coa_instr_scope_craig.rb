...
# Warning, the next variable isn't really used much NOT A THREAD SAFE WAY OF PROGRAMMING ie. MULTIPLE CORES ETC
#####################################################################################################
#####################################################################################################
#####################################################################################################
...
# end
# 
# puts "Cars have #{Car.WHEELS} wheels" # THIS DOESN'T WORK
